...
describe('testing for response from all simple requests', function () {
  beforeEach(function () {
  });
//   afterEach(function () {
    // server.close();
//   });
  it('does not respond to wrong urls', function (done) {
    request
      .get('/foobar')
      .expect(404, done);
  });
  ...
  it('responds to /summary', function (done) {
    request
      .get('/summary')
      .expect(200, done);
  });
  it('responds to /userinfo', function (done) {
    request
      .get('/userinfo')
      .expect(200, done);
  });
